...
if metrics_only ==False:
    ...
    if load_model == True:
        ...
        #best_epoch_model=7 #ask userto enter?  #print(best_models_path + 'radial_msd_depth80_it5_epoch59.pytorch')
        ...
        #orig_it=txt = input("Enter original iteration: ")
        #orig_epochs=txt = input("Enter original number of epochs: ")
        ...
        file_name = model_folder + model_file
        #bubble jordi #
        #file_name ='unet_jordi_pos1_width1_depth4_dil4_ep11_it{}_epoch{}.pytorch'.format(best_epoch, best_epoch)
        #file_name='unet_pos1_width1_depth4_dil4_ep10_it3/unet_depth4_it1_epoch{}.pytorch'.format(best_epoch)   #bubble shan 
        print(network_path + file_name)        
        #file_name='unet_jordi_pos1_width1_depth4_dil4_ep18_it2/unet_jordi_depth4_it2_epoch{}.pytorch'.format(best_epoch)   #bubble jordi  extra 18 from ep2
        model.load(network_path + file_name)  #should be best_models_path
        #model.load(best_models_path + file_name)   #for best epoch jordi
    ...
    print(test_scans)
    phantoms = [9, 13,16,19,33,36,37] #test_scans  #[35,27,15,3,39,7,33]  inherit test_scans
