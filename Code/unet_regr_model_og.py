...
class UNetRegressionModel(MSDModel):
    def __init__(self,run_network_path,  c_in, c_out, depth, width, loss_function, dilation, reflect, conv3d):
        # Initialize msd network.
        super().__init__(c_in, c_out, 1, 1, dilation)
        self.run_network_path=run_network_path
        ...
        self.net.cuda()
        print(self.net, file=open(self.run_network_path + "model_summary.txt", "a"))
