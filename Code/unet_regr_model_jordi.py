...
class UNetRegressionModelJordi(MSDModel):
    def __init__(self, network_path, c_in, c_out, depth, width, loss_function, dilation, reflect, conv3d):
        ...
        self.criterion = loss_functions[self.loss_function]
        assert(self.criterion is not None)
        # Make Unet
        self.msd = UNet(c_in, 1)  #trainable model
        # Initialize network
        self.net = nn.Sequential(self.scale_in, self.msd, self.scale_out)
        self.net.cuda()
        #network_path="/bigstore/shannon/"
