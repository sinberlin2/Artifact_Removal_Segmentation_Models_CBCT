...
if metrics_only ==False:
    ...
    if load_model == True:
        ...
        file_name ='{}_pos{}_width{}_depth{}_dil{}_ep{}_it{}_epoch{}.pytorch'.format(architecture, pos, width, depth, dilation_f,epochs, it, best_epoch)
        print(best_models_path + file_name)        
    ...
    #set optimizer and learning rate
        ...
        for epoch in range(epochs):
            ...
            #true_masks = true_masks.to(device=device, dtype=mask_type)
                optimizer.zero_grad()
                masks_pred = model(imgs) #or mode.forward()
